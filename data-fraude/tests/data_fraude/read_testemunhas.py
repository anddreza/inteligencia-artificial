...
print(f"Numero: {numero_de_registros}")

#Número de acidentes com testemunhas presentes com homens entre 20 e 50 anos e com veiculos Sedan no mês de Janeiro
print('-------------------------------------')
